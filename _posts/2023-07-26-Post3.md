...
- First page can take a longer time to load if the app is big
...
- `createHashRouter`
    - Instead of using normal URLs, it will use the hash portion of the URl to manager the "application URL"
## Nested Routes 

- ***Nested Routes***
    - Allows multiple components to render on the same page 
    - Defines routes in a hierarchical manner
